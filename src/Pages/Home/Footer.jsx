  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/alphajedidia.png" alt="Logoipsum" width="200px"/>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://web.facebook.com/tahiriniainaalphajedidia/"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/alphajedidia/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Alpha Jedidia</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
